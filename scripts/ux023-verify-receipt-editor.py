...
require('owned_receipt_read_model', 'api_receipt_detail_read_model_v1' in sql and 'r.user_id = p_user_id' not in sql and 'u.telegram_user_id = p_telegram_user_id' in sql)
