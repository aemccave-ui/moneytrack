    ...
    >
      ...
      <div className="heroMetricRow">
        <div className="heroMetric resultMetric">
          <span>Сальдо</span>
          <strong className={`sensitive ${sizeClass(resultText)}`.trim()}>{resultText}</strong>
        </div>

        <div className="heroMetric incomeMetric">
          <span>Доход</span>
          <strong className={`sensitive ${sizeClass(incomeText)}`.trim()}>{incomeText}</strong>
        </div>

        <div className="heroMetric expenseMetric">
          <span>Расход</span>
          <strong className={`sensitive ${sizeClass(expenseText)}`.trim()}>{expenseText}</strong>
        </div>
      </div>
    </section>
  )
